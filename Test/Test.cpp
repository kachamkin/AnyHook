...
{
    UseStealth = TRUE;
    SetRemoteHook(L"kernel32.dll", L"TerminateProcess", L"C:\\Users\\kacha\\source\\repos\\AnyHook\\x64\\Debug\\Shadow.dll", L"ShadowTerminateProcess", 21696);
    Sleep(1);
    RemoveRemoteHook(L"TerminateProcess", 21696);
